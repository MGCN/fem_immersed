...
/****************************************************************/
#ifndef STOREOPERATOR_H
#define STOREOPERATOR_H
...
class StoreOperator : public GeneralUserObject
{
public:
    StoreOperator(const InputParameters & parameters);
    ...
    const  std::shared_ptr<SparseMatT> & computeOp1(){ return _B;}
    const  std::shared_ptr<SparseMatT> & computeOp2(){ return _B;}
