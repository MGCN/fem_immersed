...
/****************************************************************/
#include "NeumannStresses_positive.h"
#include "MooseMesh.h"
registerMooseObject("ImmersedBoundaryApp", NeumannStresses_positive);
template<>
...
NeumannStresses_positive::NeumannStresses_positive(const InputParameters & parameters) :
...
Real
NeumannStresses_positive::computeQpResidual()
{
...
Real
NeumannStresses_positive::computeQpJacobian()
{
...
Real
NeumannStresses_positive::computeQpOffDiagJacobian(unsigned int jvar)
{
